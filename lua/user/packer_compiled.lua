...
_G.packer_plugins = {
  ...
  ["lightspeed.nvim"] = {
    loaded = true,
    path = "/Users/apple/.local/share/nvim/site/pack/packer/start/lightspeed.nvim",
  ...
  ["minimal.nvim"] = {
    loaded = true,
    path = "/Users/apple/.local/share/nvim/site/pack/packer/start/minimal.nvim",
  ...
  ["pretty-fold.nvim"] = {
    ...
    loaded = true,
    path = "/Users/apple/.local/share/nvim/site/pack/packer/start/pretty-fold.nvim",
  ...
  ["vim-illuminate"] = {
    loaded = true,
    path = "/Users/apple/.local/share/nvim/site/pack/packer/start/vim-illuminate",
  ...
  ["vim-mustache-handlebars"] = {
    ...
    needs_bufread = true,
    only_cond = false,
    path = "/Users/apple/.local/share/nvim/site/pack/packer/opt/vim-mustache-handlebars",
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'Comment.nvim', 'vim-mustache-handlebars', 'lualine.nvim', 'vim-matchup', 'toggleterm.nvim', 'project.nvim', 'nvim-web-devicons', 'popup.nvim', 'nvim-tree.lua', 'nvim-colorizer.lua', 'close-buffers.nvim', 'gitsigns.nvim', 'which-key.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
